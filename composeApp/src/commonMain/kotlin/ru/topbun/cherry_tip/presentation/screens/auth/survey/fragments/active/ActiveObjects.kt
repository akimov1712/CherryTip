...
sealed class ActiveObjects(
    ...
    data object Inactive: ActiveObjects(ActiveType.INACTIVE, Res.string.inactive_title, Res.string.inactive_descr)
    data object Moderate: ActiveObjects(ActiveType.MODERATE, Res.string.moderate_title, Res.string.moderate_descr)
    data object Active: ActiveObjects(ActiveType.ACTIVE, Res.string.active_title, Res.string.active_descr)
