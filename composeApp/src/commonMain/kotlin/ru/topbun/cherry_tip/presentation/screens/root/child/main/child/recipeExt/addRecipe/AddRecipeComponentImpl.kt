...
class AddRecipeComponentImpl(
    ...
    override fun changeProtein(protein: String?) = store.accept(ChangeProtein(protein))
    override fun changeCarbs(carbs: String?) = store.accept(ChangeCarbs(carbs))
    override fun changeFat(fat: String?) = store.accept(ChangeFat(fat))
